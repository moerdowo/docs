...
4. You will see the "Custom" form. Fill in the required details, including: Template Default dropdown: Chose the template that have you created. Tambah Field: Create a new field. Field Tipe Isian: Various type of Data.  Label Nama: Create your Label Name. Teks Bantuan (optional): Fill for additional description of field. Isian ini dropdown: You can chose that this field is optional or mandatory.
