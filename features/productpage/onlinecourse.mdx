...
You have access to a default fundraising link in the Mayar dashboard under Online Course. This default link, when shared with customers, allows them to manually enter the amount they want to send/pay to you.Below are the steps involved in managing the default Online Course link:
