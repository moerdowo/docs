...
You have access to a default Online Course link in the Mayar dashboard under Online Course. This default link, when shared with customers, allows them to manually enter the amount they want to send/pay to you. Here are the steps to manage the default Online Course link:

1. Click on Online Course in the left sidebar.
