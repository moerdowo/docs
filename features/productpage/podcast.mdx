...
<Steps>
  <Step title="Log in to Dashboard">
    First, log in to your Mayar Dashboard. Make sure you are signed in to your account and on the main Dashboard page. Here, you will begin the process of creating a Podcast product.
  </Step>
  ...
  <Step title="Select Podcast Option">
    From the product menu, select the **“Podcast”** option to start creating your Podcast product. This will open a new window titled **“Create Podcast”**, where you’ll be asked to provide various details about the product you’re making.

    ![Gambar29 Pn](/images/gambar29.png)
  </Step>
  <Step title="Fill in Product Details">
    In the **"Create Podcast"** window, you’ll need to fill in product details as follows:
  ...
  <Step title="View Product Details Page">
    After filling out all the details and successfully creating your Podcast product, you’ll be redirected to the **Product Detail Page**. Here, you can see all the information as follows:

    ![Gambar HD143 Pn](/images/gambarHD143.png)
  ...
  <Step title="Congratulations!">
    Congratulations\! You have successfully created a Podcast product in Mayar\!
  </Step>
</Steps>
