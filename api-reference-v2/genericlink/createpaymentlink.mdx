...
openapi: "POST /endpointgenericlinkv2/createpaymentlink"
description: "Endpoint used to create a generic payment link product"
---
...
not captured from a live prod write. This route shares the same handler and
request body as POST /products/create. `messages` is PLURAL on this endpoint. */}
...
```Sandbox Sandbox
https://api.mayar.io/hl/v2/products/payment-link/create
```
