...
<ParamField path="description" type="string">
  Webinar product description (3–555 characters).
</ParamField>

<ParamField path="amount" type="integer" required>
  Webinar price amount (minimum `500`).
</ParamField>
...
<ParamField path="eventStartAt" type="string | datetime">
  Webinar start date as a 24-character ISO 8601 UTC string.
</ParamField>

<ParamField path="eventEndAt" type="string | datetime">
  Webinar end date as a 24-character ISO 8601 UTC string.
</ParamField>

<ParamField path="expiredAt" type="string | datetime">
  Webinar product expiration date as a 24-character ISO 8601 UTC string.
</ParamField>
