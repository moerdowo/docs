...
```Sandbox Sandbox
https://api.mayar.io/hl/v2/coupons/create
```
...
<ParamField path="products" type="array">
  ...
  products. Each item can be either a product `id` string or an object with an
  `id` field you own — both forms are accepted:

  - `"products": ["c9aa143a-53f9-44e7-a9c6-83229ad7199b"]`
  - `"products": [{ "id": "c9aa143a-53f9-44e7-a9c6-83229ad7199b" }]`
</ParamField>
