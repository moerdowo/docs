...
curl --request POST 'https://api.mayar.id/credit/v2/credit/membership/customer/regist' \
...
https://api.mayar.id/credit/v2/credit/membership/customer/regist
```

```Sandbox Sandbox
https://api.mayar.io/credit/v2/credit/membership/customer/regist
```
