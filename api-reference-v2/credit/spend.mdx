...
curl --request POST 'https://api.mayar.id/credit/v2/credit/customer/spend' \
...
https://api.mayar.id/credit/v2/credit/customer/spend
```

```Sandbox Sandbox
https://api.mayar.io/credit/v2/credit/customer/spend
```
