...
curl --request POST 'https://api.mayar.id/credit/v2/credit/customer/add-credit' \
...
https://api.mayar.id/credit/v2/credit/customer/add-credit
```

```Sandbox Sandbox
https://api.mayar.io/credit/v2/credit/customer/add-credit
```
