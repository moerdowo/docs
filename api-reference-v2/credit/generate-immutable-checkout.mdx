...
curl --request POST 'https://api.mayar.id/credit/v2/credit/generate/immutable/checkout' \
...
https://api.mayar.id/credit/v2/credit/generate/immutable/checkout
```

```Sandbox Sandbox
https://api.mayar.io/credit/v2/credit/generate/immutable/checkout
```
