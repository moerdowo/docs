...
<ParamField path="description" type="string">
  Event product description in text or HTML format (3–555 characters).
</ParamField>

<ParamField path="amount" type="integer" required>
  Event ticket or product price amount (minimum `500`).
</ParamField>
...
<ParamField path="startAt" type="string | datetime">
  Sales start date as a 24-character ISO 8601 UTC string.
</ParamField>

<ParamField path="eventStartAt" type="string | datetime">
  Event start date as a 24-character ISO 8601 UTC string.
</ParamField>

<ParamField path="eventEndAt" type="string | datetime">
  Event end date as a 24-character ISO 8601 UTC string.
</ParamField>

<ParamField path="expiredAt" type="string | datetime">
  Event product expiration date as a 24-character ISO 8601 UTC string.
</ParamField>
...
<ParamField path="event.isOnlineEvent" type="boolean" required>
  Indicates whether the event is conducted online.
</ParamField>

<ParamField path="event.maxTicket" type="number">
  Maximum number of tickets that can be purchased per transaction (1–50). Defaults
  to `50` when omitted.
</ParamField>
