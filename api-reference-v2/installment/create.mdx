        ...
        "invoices": [
            {
                ...
                "status": "unpaid",
                "link": "mkcn4u72ki",
                "paymentUrl": "https://yourstore.myr.id/invoices/mkcn4u72ki"
            },
            {
                ...
                "status": "unpaid",
                "link": "0ll429zxvsue",
                "paymentUrl": "https://yourstore.myr.id/invoices/0ll429zxvsue"
            },
            {
                ...
                "status": "unpaid",
                "link": "h8fiobqkek",
                "paymentUrl": "https://yourstore.myr.id/invoices/h8fiobqkek"
            }
        ],
...
```Sandbox Sandbox
https://api.mayar.io/hl/v2/installments/create
```
...
<ResponseField name="paymentUrl" type="string">
  Full checkout URL for this installment term, e.g.
  `https://<merchant>.myr.id/invoices/<link>`.
</ResponseField>
