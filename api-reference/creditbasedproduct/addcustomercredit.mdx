...
description: "This endpoint is used to add credit to a customer’s on particular credit usage product."
---
...
```Sandbox Sandbox
https://api.mayar.io/credit/v1/credit/customer/add-credit
```
...
<ParamField query="customerId" path="customerId" type="string" required>
...
<ResponseField name="customerBalance" type="string">
