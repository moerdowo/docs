...
## Request Body
<RequestField name="paymentLinkId" type="string" required>
  Unique identifier of the payment link.
</RequestField>

<RequestField name="tickets" type="array" required>
  List of selected tickets for the checkout. Leave empty if not applicable.
</RequestField>

<RequestField name="couponCode" type="string" required>
  Coupon code applied to the checkout. Leave empty if not used.
</RequestField>

<RequestField name="finalAmount" type="integer" required>
  Final amount to be paid after discounts or adjustments.
</RequestField>

<RequestField name="customerEmail" type="string" required>
