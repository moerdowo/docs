...
```Sandbox Sandbox
https://api.mayar.io/hl/v1/coupon/{id}
```
...
<ParamField path="minimumPurchase" type="integer" >
...
<ParamField path="totalCoupons" type="integer" >
  Total number of coupons available.
</ParamField>

<ParamField path="value" type="integer" >
  Discount value.
</ParamField>
...
<ParamField path="discountId" type="string<uuid>" >
  Related Discount ID.
</ParamField>
