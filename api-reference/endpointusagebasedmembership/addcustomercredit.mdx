...
curl --location 'api.mayar.club/credit/v1/credit/customer/add-credit' \
...
api.mayar.id/credit/v1/credit/customer/add-credit
```


```Sandbox Sandbox
api.mayar.club/credit/v1/credit/customer/add-credit
```
