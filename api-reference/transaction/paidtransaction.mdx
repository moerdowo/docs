...
<ResponseField name="xenditTransactionId" type="string" >
...
<ResponseField name="xenditTransaction" type="string" >
...
<ResponseField name="urlParamTrackingData" type="string" >
  Tracking URL data (if any).
</ResponseField>

<ResponseField name="isAdminFeeBorneByCustomer" type="boolean" >
  Whether the admin fee is borne by the customer.
</ResponseField>

<ResponseField name="isChannelFeeBorneByCustomer" type="boolean" >
