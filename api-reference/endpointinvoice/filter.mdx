---
title: "GET Sort/filter Invoice"
description: "Endpoint used to filter invoices that have been created"
---

<RequestExample>

```bash Request Example
curl --location 'https://api.mayar.id/hl/v1/invoice?sort=closed' \
