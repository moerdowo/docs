...
<ParamField path="createdAt" type="integer (timestamp)" required>
  Creation time of the webhook delivery log.
</ParamField>

<ParamField path="nextDelivery" type="string | null" required>
...
<ParamField path="payload" type="string (JSON string)" required>
...
<ParamField path="updatedAt" type="integer (timestamp)" required>
...
<ParamField path="paymentLinkTransactionId" type="string (UUID)" required>
  Associated transaction ID.
</ParamField>

<ParamField path="urlDestination" type="string (URL)" required>
  Destination endpoint where the webhook is delivered.
</ParamField>

<ParamField path="responsePayload" type="string | null" required>
