...
```Sandbox Sandbox
https://api.mayar.io/credit/v1/credit/membership/customer/regist
```
...
<ParamField query="userId" path="userId" type="string" >
...
<ParamField query="createdAt" path="createdAt" type="integer" >
  Timestamp (in milliseconds) indicating when the membership was created.
</ParamField>

<ParamField query="nextPayment" path="nextPayment" type="integer" >
...
<ParamField query="id" path="id" type="string" >
  Unique identifier of the payment link.
</ParamField>

<ParamField query="name" path="name" type="string" >
  Name of the payment link or product.
</ParamField>

<ParamField query="description" path="description" type="string" >
