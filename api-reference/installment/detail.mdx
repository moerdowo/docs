...
```Sandbox Sandbox
https://api.mayar.io/hl/v1/installment/{id}
```
...
<ParamField path="tenure" type="integer" >
  Installment duration (in months).
</ParamField>

<ParamField path="dueDate" type="integer" >
  Due date value (example: `11`).
</ParamField>

<ParamField path="interest" type="integer" >
  Interest value.
</ParamField>
...
<ParamField path="expiredAt" type="integer" >
...
<ParamField path="link" type="integer" >
...
<ParamField query="interestAmount" path="param" type="integer" >
  Interest amount for the invoice.
</ParamField>

<ParamField path="remainingAmount" type="integer" >
