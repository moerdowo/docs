...
curl --request POST 'https://api.mayar.id/hl/v1/product/digital-product/create'\
...
https://api.mayar.id/hl/v1/product/digital-product/create
```

```Sandbox Sandbox
https://api.mayar.club/hl/v1/product/digital-product/create
```
