...
<Warning>
  **API V1 deprecation notice:** The Mayar Headless **API V1** will be **deprecated on
  1 October 2026**. After that date, V1 endpoints will no longer be available. Please migrate
  your integration to [API V2](/api-reference-v2/introduction) before then. See the
  [V1 to V2 migration guide](/api-reference-v2/migration-from-v1) for every breaking change and
