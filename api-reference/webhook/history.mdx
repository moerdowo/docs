...
<Note>
  This `/history` endpoint is **deprecated** and only returns **old** webhook
  history. For the current and up-to-date webhook history, please use the new
  endpoint: `GET /hl/v2/webhooks/new-history` (see
...
```Sandbox Sandbox
https://api.mayar.io/hl/v1/webhook/history?page=1&pageSize=10
```
